...
def get_dashboard(
    ...
    # ... (Implementing the rest of dashboard logic from original main.py largely unchanged but cleaner)
    # Reducing verbosity for this thought block, but will write full code
    ...
    # Simply returning stats structure
    return {
        "num_calls": num_calls,
        "avg_time_taken": avg_time,
        "upload_counts": {"today": today_count},
        "username": username
...
def get_user_calls(
    ...
    return {
        ...
        "calls": call_data, # Pydantic will serialize
        "username": username
    }
...
def download_pdf(
    ...
    pdf_path = generate_call_pdf_report(
        session_id, 
        call_record.translation_en or call_record.recognized_text,
        call_record.Agent_performance_summary
    )
